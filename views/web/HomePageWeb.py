...
class HomePageWeb(ft.UserControl):
    ...
    def build(self):
        ...
        content=ft.Row(spacing=10,alignment=ft.MainAxisAlignment.SPACE_BETWEEN,controls=[ft.Icon(name=ft.icons.CANCEL_OUTLINED,size=25, color="red"),ft.Text("Será necessário preencher todos os dados para envio!",size=25 ,weight="bold",color="black")])
    )
        mail_sucess_dialog = ft.AlertDialog(
        
        content=ft.Row(spacing=10,alignment=ft.MainAxisAlignment.SPACE_BETWEEN,controls=[ft.Icon(name=ft.icons.CHECK_CIRCLE_OUTLINE,size=25, color="green"),ft.Text("E-mail enviado com sucesso!", weight="bold",color="black",size=25)])
    
    )
        
        erro_conexion_dialog = ft.AlertDialog(
        
        content=ft.Row(spacing=10,alignment=ft.MainAxisAlignment.SPACE_BETWEEN,controls=[ft.Icon(name=ft.icons.SIGNAL_WIFI_CONNECTED_NO_INTERNET_4_SHARP,size=25, color="red"),ft.Text("Erro na conexão!, verifique sua rede.", weight="bold",color="black",size=25)])
                    ...
                    ft.Container(bgcolor="white",
                                ...
                                content=ft.Row(
                                    ...
                                    controls=[
                                        ...
                                        ft.Container(
                                                    height=800, 
                                                    width=self.page.width/2.50,
                                                    content = ft.Column(
                                                        
                                                        controls=[
                                                            
                                                            ft.Container(
                                                                padding=ft.padding.only(left=60, top=50),
                                                                content=ft.Row(
                                                                    controls=[
                                                                ...
                                                                content=ft.Row(
                                                                    ...
                                                                    controls=[
                                                                        ...
                                                                        ft.Container(
                                                                            ...
                                                                            content=ft.Text("Sobre mim", size=30, font_family="Roboto", color="black"),
                                                                        )
                                                             ...
                                                             ft.Container(
                                                                ...
                                                                content=ft.ResponsiveRow(
                                                                    ...
                                                                    controls=[
                                                                        ...
                                                                        ft.Text(value=sobre_mim, font_family="Roboto",size=15, text_align=ft.TextAlign.START, color="black"),
                    ...
                    ft.Container(bgcolor="white",
                                ...
                                content=ft.Row(
                                    ...
                                    controls=[
                                                        ...
                                                        controls=[
                                                          ...
                                                          ft.ResponsiveRow(
                                                              ...
                                                              controls=[
                                                                  ...
                                                                  ft.Divider(color="transparent"),
                                                                  ft.Text("Me envie um E-mail" ,size=30, weight="bold", color="black"),
                                                                  ft.Divider(color="transparent"),
                                                                  ft.Divider(color="transparent"),
                                                              ]
                                        ...
                                        ft.Container(
                                                    height=600, 
                                                    padding=ft.padding.only(top=20, bottom=30, right=20),
                                                    alignment=ft.alignment.center_left,
                                                    width=self.page.width/2.75,
                                                    margin=0,
                                                    content = ft.Column(
                                                        ...
                                                        controls=[
                                                            ft.Divider(color="transparent"),
                                                            ft.ResponsiveRow(
                                                              controls=[ft.Text("Entre em Contato" ,size=30, weight="bold", color="black")
                                                                  ]
                                                            ...
                                                            ft.Divider(color="transparent"),
                                                            ft.ResponsiveRow(
                                                              controls=[ft.Text("Quero agradecer por você ter chegado até aqui demonstrando que visualizou todo meu portifólio, sinta-se a vontade para me contactar pelas redes sociais abaixo, pois seu contato será muito importante para minha carreira.",text_align="justify", color="black", size=19)]
                ...
                content=ft.Column(
                    ...
                    ft.Container(
                        ...
                        content=ft.Column(
                            ...
                            ft.ResponsiveRow(
                                controls=[
                                    ft.Text(value=list_title,weight="bold", size=17, text_align="center",font_family="Roboto", color="black" ),
                                    ft.Text(value=list_text, text_align="center", size=18, font_family="Roboto", color="black")
                                ]
                            )
                            ...
                            ft.Row(
                                ...
                                controls=[
                                    ft.Column([
                                        ...
                                        ft.Text(value=list_title, weight="bold", size=20, text_align="center", font_family="Roboto", color="black"),
                                    ft.Text(value=list_type+": ",weight="normal", size=17, text_align="center",font_family="Roboto", color="blue", spans=[ft.TextSpan(text=list_data,style=ft.TextStyle(color="black")) ]
                                    ),
                ...
                ft.ResponsiveRow(
                    controls=[
                        ...
                        ft.ResponsiveRow(alignment="center", controls=[
                            ...
                            ft.Text(value="SERVIÇOS", size=30, weight="bold", text_align="center", color="black", font_family="Roboto"),
                            ft.Text(value="Descrição de serviços que podem ser realizados", size=20, weight="normal", text_align="center", color="black", font_family="Roboto"),
